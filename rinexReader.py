    ...
    def read(self,path, return_type = 'tensor'):
        with open(path,'r') as rinex_:
            ...
            if return_type == 'xDataFrame':
                self.data = codecs.read_rinex(rinex, return_type = return_type).observations
            elif return_type == 'raw':
                self.data, self.header = codecs.read_rinex(rinex, return_type = return_type).observations
            elif return_type == 'tensor':
                self.data = codecs.read_rinex(rinex, return_type = return_type)
...
class __sp3__:
    ...
    def read(self,path, return_type = False):
        with open(path,'r') as sp3_:
            ...
            if return_type == 'raw':
                data = codecs.read_sp3(sp3, return_raw = return_type).observations
            elif return_type == 'xDataFrame':
                data, self.header = codecs.read_sp3(sp3, return_type = return_type).observations
            elif return_type == 'tensor':
                data = codecs.read_sp3(sp3, return_type = return_type).data
...
if __name__ == '__main__':
    ...
    #type = 'rinex'
    type = 'sp3'
    email = input('give me your email adress registered to https://cddis.nasa.gov/Data_and_Derived_Products/CDDIS_Archive_Access.html')
